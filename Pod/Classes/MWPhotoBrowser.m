...
- (void)_playVideo:(NSURL *)videoURL atPhotoIndex:(NSUInteger)index {
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:_currentVideoPlayerViewController
                                                    name:AVPlayerItemFailedToPlayToEndTimeNotification object:_currentVideoPlayerViewController.player];
    [[NSNotificationCenter defaultCenter] removeObserver:_currentVideoPlayerViewController
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(videoFinishedCallback:)
                                               ...
                                               object:_currentVideoPlayerViewController.player];
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(videoFailCallBack:) name:AVPlayerItemFailedToPlayToEndTimeNotification object:_currentVideoPlayerViewController.player];
    [[NSNotificationCenter defaultCenter] addObserver:self
